...
\caption{Comparaison visuelle des performances des 7 modèles (métriques de classification et ROC-AUC).}
...
\caption{Top des variables les plus contributives dans le modèle XGBoost.}
...
\caption{Distribution des clients par segment et comparaison des taux de churn associés.}
